...
![SymbIOTics exploded view](SymbIOTics/schematic2.png){:.half}   *SymbIOTics Smart Brick Exploded View*  ![symbIOTics assembly](SymbIOTics/sym2.jpeg){:.half} *SymbIOTics Smart Brick*
